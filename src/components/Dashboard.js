...
function Dashboard() {
  ...
  return (
    <>
      <div
        style={{position:'fixed', inset:0, width:'100vw', height:'100vh', zIndex:0, pointerEvents:'auto', overflow:'hidden', cursor:'grab'}}
      ...
      >
        ...
        <div
          ...
          style={{position:'absolute', inset:0, width:'100vw', height:'100vh', zIndex:1, pointerEvents:'auto'}}
        >
      ...
      <nav className="w-full flex items-center justify-between px-4 py-3 bg-sky-100/80 backdrop-blur-sm shadow-lg fixed top-0 left-0 z-30">
        ...
        <div className="hidden md:flex items-center gap-0">
          <div className="flex items-center bg-white/80 rounded-xl shadow border border-sky-200 px-2 py-1">
            <button
              className="px-5 py-2 text-sky-700 font-semibold text-lg hover:bg-sky-100 hover:underline focus:outline-none rounded-l-xl transition-all"
            ...
            <button
              className="px-5 py-2 bg-sky-400 hover:bg-sky-500 text-white text-lg font-semibold rounded-r-xl shadow transition-all transform hover:scale-105 hover:shadow-xl focus:outline-none"
...
const QUOTES = [ { text: "No one has ever become poor by giving.", author: "Anne Frank" }, { text: "We make a living by what we get, but we make a life by what we give.", author: "Winston Churchill" }, { text: "The simplest acts of kindness are by far more powerful than a thousand heads bowing in prayer.", author: "Mahatma Gandhi" }, { text: "It's not how much we give, but how much love we put into giving.", author: "Mother Teresa" }, { text: "Only by giving are you able to receive more than you already have.", author: "Jim Rohn" }, { text: "Happiness doesn't result from what we get, but from what we give.", author: "Ben Carson" } ];
